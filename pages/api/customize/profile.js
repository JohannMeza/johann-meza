...
const ProfileController = async (req, res) => {
  try {
    ...
    const data = { ...result.dataObject, DATA_PERSONAL: { ...result.dataObject.DATA_PERSONAL, IMAGEN: "data:image/png;base64," + CodificarBase64(result.dataObject.DATA_PERSONAL.IMAGEN) }}
